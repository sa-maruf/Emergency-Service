...
const Card = ({ copyClick }) => {
    ...
    return (
        <>
            <section className="max-w-screen-2xl mx-auto px-5 grid md:grid-cols-4 mt-14 mb-20 gap-4">
                {/* Card part */}
                <div className="md:col-span-2 lg:col-span-3 grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-4">
                ...
                {/* Clear History  */}
                <div className="md:col-span-2 lg:col-span-1 bg-[#FFFFFF] border-1 border-gray-300 rounded-md p-4">
